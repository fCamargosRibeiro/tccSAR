...
class ${className}Controller {
    ...
    def show(Long id) {
        ...
        if (!${propertyName}) {
          flash.message = message(code: 'default.not.found.message', 
              args: [message(code: '${domainClass.propertyName}.label', default: '${className}'), id])
    ...
    def update(Long id, Long version) {
      ...
      grailsApplication.getDomainClass("${packageName}.${className}").persistentProperties.each {
