...
class gsp_SAR_enderecocreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',21,['bean':(enderecoInstance),'var':("error")],3)
printHtmlPart(13)
})
invokeTag('hasErrors','g',23,['bean':(enderecoInstance)],2)
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1479909975225L
