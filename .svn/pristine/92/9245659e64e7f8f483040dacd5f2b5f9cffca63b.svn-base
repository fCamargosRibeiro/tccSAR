...
class gsp_SAR_pagamentoedit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/pagamento/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',9,['var':("entityName"),'value':(message(code: 'pagamento.label', default: 'Pagamento'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',22,['bean':(pagamentoInstance),'var':("error")],3)
printHtmlPart(13)
})
invokeTag('hasErrors','g',24,['bean':(pagamentoInstance)],2)
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(15)
invokeTag('message','g',33,['code':("default.edit.label"),'args':([entityName])],-1)
printHtmlPart(16)
invokeTag('hiddenField','g',34,['name':("id"),'value':(pagamentoInstance?.id)],-1)
printHtmlPart(17)
invokeTag('hiddenField','g',35,['name':("version"),'value':(pagamentoInstance?.version)],-1)
printHtmlPart(18)
...
invokeTag('form','g',43,['class':("pad-bg"),'url':([resource:pagamentoInstance, action:'update']),'method':("POST")],2)
printHtmlPart(22)
...
public static final long LAST_MODIFIED = 1479909974984L
