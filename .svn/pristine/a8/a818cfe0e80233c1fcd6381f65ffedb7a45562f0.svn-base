...
class gsp_SAR_clientecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',21,['bean':(clienteInstance),'var':("error")],3)
printHtmlPart(13)
})
invokeTag('hasErrors','g',23,['bean':(clienteInstance)],2)
printHtmlPart(14)
createTagBody(2, {->
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1479909975155L
