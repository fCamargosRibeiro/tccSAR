...
<html>
	...
	<g:hasErrors bean="\${${propertyName}}">
		...
		<div id="edit-${domainClass.propertyName}" class="form-group col-md-8" role="main">
                <div class="container">
                        <div class="row">
			...
			<g:form class="pad-bg" url="[resource:${propertyName}, action:'update']" method="POST" <%= multiPart ? ' enctype="multipart/form-data"' : '' %>>
