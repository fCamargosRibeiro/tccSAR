...
<html>
	...
	<g:hasErrors bean="${revendedorInstance}">
		...
		<div id="edit-revendedor" class="form-group col-md-8" role="main">
                <div class="container">
                        <div class="row">
			...
			<g:form class="pad-bg" url="[resource:revendedorInstance, action:'update']" method="POST" >
                            <h3><span><g:message code="default.edit.label" args="[entityName]" /></span></h3>
				<g:hiddenField name="id" value="${revendedorInstance?.id}" />
                <g:hiddenField name="version" value="${revendedorInstance?.version}" />
				<fieldset class="form">
